            ...
            <div className="ai-tools-grid">
              <div className="ai-tool-card">
                ...
                <div className="ai-tool-logo-container">
                  <img className="ai-tool-logo ai-logo-notebooklm" src={assetUrl('/notebooklm-logo.jpg')} alt="Logo NotebookLM" />
                </div>
              ...
              <div className="ai-tool-card">
                ...
                <div className="ai-tool-logo-container">
                  <img className="ai-tool-logo ai-logo-claude" src={assetUrl('/claude-logo.jpg')} alt="Logo Claude" />
                </div>
              ...
              <div className="ai-tool-card">
                ...
                <div className="ai-tool-logo-container">
                  <img className="ai-tool-logo ai-logo-chatgpt" src={assetUrl('/chatgpt-logo.jpg')} alt="Logo ChatGPT" />
                </div>
              ...
              <div className="ai-tool-card">
                ...
                <div className="ai-tool-logo-container">
                  <img className="ai-tool-logo ai-logo-gemini" src={assetUrl('/gemini-logo.jpg')} alt="Logo Gemini" />
                </div>
