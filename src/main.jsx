      ...
      <section className={`screen center ${active === 'ai-tools' ? 'show' : ''}`}>
        <div className="ai-tools-page">
          ...
          <div className="ai-tools-grid">
            ...
            <div className="ai-tool-card">
              <div className="ai-tool-logo-container">
                <svg className="ai-tool-logo" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="ai-tool-card">
              <div className="ai-tool-logo-container">
                <svg className="ai-tool-logo" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  {/* 16 cánh tỏa ra từ tâm */}
                  <path d="M50 50 L50 5 Q51 25 50 50 Q49 25 50 5" fill="#D97757"/>
                  <path d="M50 50 L50 95 Q51 75 50 50 Q49 75 50 95" fill="#D97757"/>
                  <path d="M50 50 L5 50 Q25 51 50 50 Q25 49 5 50" fill="#D97757"/>
                  <path d="M50 50 L95 50 Q75 51 50 50 Q75 49 95 50" fill="#D97757"/>
                  <path d="M50 50 L18 18 Q33 33 50 50 Q33 33 18 18" fill="#D97757"/>
                  <path d="M50 50 L82 82 Q67 67 50 50 Q67 67 82 82" fill="#D97757"/>
                  <path d="M50 50 L82 18 Q67 33 50 50 Q67 33 82 18" fill="#D97757"/>
                  <path d="M50 50 L18 82 Q33 67 50 50 Q33 67 18 82" fill="#D97757"/>
                  <path d="M50 50 L33 7 Q40 28 50 50 Q38 28 33 7" fill="#D97757"/>
                  <path d="M50 50 L67 93 Q60 72 50 50 Q62 72 67 93" fill="#D97757"/>
                  <path d="M50 50 L67 7 Q60 28 50 50 Q62 28 67 7" fill="#D97757"/>
                  <path d="M50 50 L33 93 Q40 72 50 50 Q38 72 33 93" fill="#D97757"/>
                  <path d="M50 50 L7 33 Q28 40 50 50 Q28 38 7 33" fill="#D97757"/>
                  <path d="M50 50 L93 67 Q72 60 50 50 Q72 62 93 67" fill="#D97757"/>
                  <path d="M50 50 L7 67 Q28 60 50 50 Q28 62 7 67" fill="#D97757"/>
                  <path d="M50 50 L93 33 Q72 40 50 50 Q72 38 93 33" fill="#D97757"/>
